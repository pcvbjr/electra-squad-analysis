...
def main():
    ...
    argp.add_argument('--training_dataset_phase', type=str, default='None')
    ...
    if training_args.do_train and args.training_dataset_phase:
        phase_indices_file = 'phase_indices.json'
        with open(phase_indices_file, 'r') as f:
            phase_indices = json.load(f)
        assert args.training_dataset_phase in phase_indices
        train_dataset_featurized = train_dataset_featurized.select(phase_indices[args.training_dataset_phase])
